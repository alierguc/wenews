...
export default class SporScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            resultData: [],
    ...
    getData = () => {
        fetch('http://newsapi.org/v2/top-headlines?country=tr&category=sports&apiKey=e75d743ff904456e99edbc30098e62e8')
